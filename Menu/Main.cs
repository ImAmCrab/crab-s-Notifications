    ...
    public class Main : MonoBehaviour
    {
        ...
        public static void CreateMenu()
        {
            ...
            text.text = PluginInfo.Name;
                ...
                component.position = new Vector3(0.06f, -0.310f, -0f);
                ...
                if (fpsCounter)
                {
                    ...
                    component2.position = new Vector3(0.06f, -0.310f, -0.04f);
        ...
        public static void CreateButton(float offset, ButtonInfo method)
        {
            ...
            gameObject.transform.localScale = new Vector3(0.09f, 0.9f, 0.18f);
            gameObject.transform.localPosition = new Vector3(0.56f, 0f, 0.0f - offset);
            ...
            component.localPosition = new Vector3(.064f, 0f, 0f);
            component.rotation = Quaternion.Euler(new Vector3(180f, 90f, 90f));
        }
